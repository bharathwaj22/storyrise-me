...
import Aryu_main_logo from "../assets/images/aryu-main-logo.svg";
...
import Video2 from "../assets/images/videos/arvideo2.mp4";
import Video3 from "../assets/images/videos/arvideo2.mp4";
...
function Aryu_case() {
  ...
  // const instarate = {
  //   hidden: { opacity: 0, x: -300, y: -300, rotate: -90 },
  //   visible: {
  //     opacity: 1,
  //     x: 300,
  //     y: 0,
  ...
  // const facebookside1 = {
  //   hidden: { opacity: 0, x: 600, y: -50, rotate: 90 },
  //   visible: {
  //     opacity: 1,
  //     x: 700,
  //     y: 0,
  ...
  // };
  // const facebookside2 = {
  //   hidden: { opacity: 0, x: 600, y: 500, rotate: 90 },
  //   visible: {
  //     opacity: 1,
  //     x: 700,
  //     y: 250,
  ...
  // const youtubeside = {
  //   hidden: { opacity: 0, x: -300, y: -500, rotate: -90 },
  //   visible: {
  //     opacity: 1,
  //     x: 300,
  //     y: 0,
  ...
  // const youtubeside2 = {
  //   hidden: { opacity: 0, x: "90%", y: 500, rotate: -90 },
  //   visible: {
  //     opacity: 1,
  //     x: 600,
  //     y: 500,
  ...
  // const cardside = {
  //   hidden: { opacity: 0, x: -300, y: -500, rotate: -180 },
  //   visible: {
  //     opacity: 1,
  //     x: 0,
  //     y: 0,
...
const cardside = {
  ...
  // const cardside1 = {
  //   hidden: { opacity: 0, x: -300, y: 100, rotate: -180 },
  //   visible: {
  //     opacity: 1,
  //     x: 0,
  //     y: 0,
  ...
  // const cardside3 = {
  //   hidden: { opacity: 0, x: "20%", y: -200, rotate: -180 },
  //   visible: {
  //     opacity: 1,
  //     x: 0,
  //     y: 0,
    ...
    <section className="pb-1">
      <section className="header-iamge position-relative">
        ...
        <section>
          <div className="text-center mt-5 ">
            <h1>
              <span className="aryu-color-start">Aryu</span>
              <span className="aryu-color-end mx-3">Academy</span>
            </h1>
          </div>
        </section>
      </section>
          ...
          <div className="hero-section ">
            <div className="hero-img">
              <div className="hero-img-inside">
                <img src={Aryu} alt="aryu" className="aryu-profile" />
              </div>
              <div className=" text-center founder-box">
                <div className="aryu-names pt-2">Yuvaraj T</div>
                <div className="aryu-names-found ">
                  Founder of Aryu Academy{" "}
                </div>
              </div>
            </div>
      ...
      <div className=" pt-5 mt-4">
        ...
        <div className="carousel-container mt-3">
          ...
          >
            ...
            <div className="carousel-item" onClick={coffeeCase}>
              <img src={Coffie_banner} alt="Coffee House" />
            </div>

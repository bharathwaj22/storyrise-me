...
import Storyowner from "../assets/images/hoodie.jpg";
    ...
    <section className="pb-1">
      <section className="header-iamge position-relative">
        ...
        <section>
          <div className="text-center mt-5 ">
            <h1>
              <span className="aryu-color-start">Story</span>
              <span className="aryu-color-end mx-3">Rise</span>
            </h1>
          </div>
        </section>
      </section>
          ...
          <div className="hero-section">
            <div className="hero-img">
              <div className="hero-img-inside">
                <img src={Storyowner} alt="aryu" className="aryu-profile" />
              </div>
              <div className=" text-center founder-box">
                <div className="aryu-names pt-2">Vingesh</div>
                <div className="aryu-names-found ">
                  Founder of Storyrise{" "}
                </div>
              </div>
            </div>
      ...
      <section className="text-align-top overflow-hidden">
        ...
        <div className="d-flex justify-content-center ">
          ...
          <div
            ...
            onClick={() =>
              window.open(
                "https://www.instagram.com/hoodieguy98?igsh=dWhyamgxZnNtazB6 ",
                "_blank"
              )
            }
          >
        ...
        <div className="carousel-container mt-3">
          ...
          >
            <div className="carousel-item" onClick={aryuCase}>
              <img src={Aryu_banner} alt="Hoodie Guy" />
            </div>
